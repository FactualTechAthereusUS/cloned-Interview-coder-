...
echo "The Eye of Providence icon has been completely removed."
echo ""
...
gh release create v1.0.20-original-icons \
  ...
  --notes "This release contains the Interview Coder application packages with the original icons completely restored. The Eye of Providence icon has been removed from all parts of the application." \
