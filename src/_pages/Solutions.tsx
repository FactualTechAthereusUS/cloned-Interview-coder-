            ...
            <div className="rounded-lg overflow-hidden">
              ...
              {solutionData && (
                <div className="flex flex-row">
                  {/* Left side: Explanation, Thoughts, Complexity */}
                  <div className="w-1/2 px-4 py-3 space-y-4 border-r border-gray-700/50">
                    <ContentSection
                  ...
                  {/* Right side: Solution Code and Dry Run */}
                  <div className="w-1/2 px-4 py-3 space-y-4">
                    <SolutionSection
                      title="Solution"
                    ...
                    {problemStatementData?.examples && (
                      <div className="space-y-2 relative">
                        ...
                        <div className="text-[13px] leading-[1.4] text-gray-100 bg-white/5 rounded-md p-3">
                          <div className="space-y-3">
                            {problemStatementData.examples.map((example, index) => (
